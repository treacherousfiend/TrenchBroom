...
namespace TrenchBroom {
    ...
    namespace Renderer {
        ...
        public:
            ...
            /**
             * Adds multiple textured lines with the given endpoints. Each line to be added consists of two consecutive
             * of the given list, so for each line, two elements of the list are used.
             *
             * @param texture the texture to use
            ...
            /**
             * Adds multiple textured triangles using the corner positions in the given list. For each triangle, three
             * positions are used.
             *
             * @param texture the texture to use
            ...
            /**
             * Adds multiple textured quads using the corner positions in the given list. For each quad, four positions
             * are used.
             *
             * @param texture the texture to use
             * @param vertices the corner positions
