...
namespace TrenchBroom {
    namespace Renderer {
        ...
        void ObjectRenderer::renderOpaque(RenderState& renderState, RenderBatch& renderBatch) {
            m_brushRenderer.renderOpaque(renderState, renderBatch);
            m_entityRenderer.render(renderState, renderBatch);
            m_groupRenderer.render(renderState, renderBatch);
        }

        void ObjectRenderer::renderTransparent(RenderState& renderState, RenderBatch& renderBatch) {
            m_brushRenderer.renderTransparent(renderState, renderBatch);
        }
    }
}
