...
namespace TrenchBroom {
    ...
    namespace Renderer {
        ...
        public:
            ...
            void renderFrustum(RenderState& renderState, float size, const Color& color) const;
        ...
        private:
            ...
            virtual void doRenderFrustum(RenderState& renderState, float size, const Color& color) const = 0;
